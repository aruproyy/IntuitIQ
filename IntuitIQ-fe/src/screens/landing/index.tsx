...
import {
    ArrowRight, Brain, CheckCheck, CheckCircleIcon, Wallet, Calculator, Sigma, Square, FunctionSquare, PieChart, Divide,
    Plus, Minus, X, Equal, Pi, Infinity as InfinityIcon
} from 'lucide-react';
        ...
        <>
            {symbols.map(({ Icon, ...symbol }, index) => (
                <motion.div
                    ...
                    transition={{ duration: symbol.duration, delay: symbol.delay, repeat: Infinity, repeatType: "loop", ease: "linear" }}
    ...
    const features = [
        {
            ...
            Icon: Square,
            animation: { hidden: { opacity: 0, x: -50 }, visible: { opacity: 1, x: 0 } }
        },
        {
    ...
    return (
        <div className="font-sans overflow-x-hidden">
            <div className="relative h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 to-purple-900 overflow-hidden">
                ...
                />
                <motion.div
                    animate={{ x: [0, 200, 0], y: [0, -150, 0], rotate: [0, 180, 360] }}
                    ...
                    >
                        <SignInButton>
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="bg-white text-indigo-700 font-bold px-8 py-4 rounded-lg hover:bg-indigo-100 transition flex items-center justify-center gap-2 text-lg"
                            >
                        ...
                        <motion.a
                            ...
                            whileHover={{ scale: 1.05, boxShadow: "0 5px 15px rgba(255, 255, 255, 0.3)" }}
                            whileTap={{ scale: 0.95 }}
                            className="bg-transparent border-2 border-white text-white font-bold px-8 py-4 rounded-lg hover:bg-white/10 transition flex items-center justify-center gap-2 text-lg"
                        >
                            Learn More
                        </motion.a>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {features.map(({ Icon, ...feature }, idx) => (
                            <AnimatedSection key={idx} delay={0.1 * idx}>
                                ...
                                >
                                    <motion.div
                                        animate={{ x: [-100, 300], rotate: [0, 360] }}
                ...
                <div className="container mx-auto px-4">
                    <AnimatedSection>
                        <div className="text-center mb-16">
                            ...
                            <p className="text-gray-600 max-w-2xl mx-auto text-lg">The brilliant minds behind IntuitIQ</p>
                        </div>
                    </AnimatedSection>
                    <AnimatedSection delay={0.2}>
                        <Carousel withIndicators loop height={450} slideGap="md" plugins={[autoplay.current]}
                            ...
                            {creators.map((creator, idx) => (
                                <Carousel.Slide key={idx}>
                                    <motion.div
                                        ...
                                        className="bg-white rounded-xl shadow-lg h-full flex flex-col lg:flex-row items-center justify-center p-8 gap-8 relative overflow-hidden"
                                    >
                                        <motion.div
                                            animate={{ x: [0, 50, 0], y: [0, -30, 0], rotate: [0, 180, 360] }}
                                            transition={{ duration: 25, repeat: Infinity, repeatType: "loop", ease: "linear" }}
                                        ...
                                        >
                                            ...
                                            >
                                                <img src={creator.photo} alt={creator.name}
                                                    className="w-32 h-32 lg:w-60 lg:h-60 rounded-full object-cover border-4 border-indigo-500 shadow-md"
                                                />
                                                <motion.div
                                        ...
                                        <div className="text-center lg:text-left relative z-10">
                                            ...
                                            <p className="text-gray-700 font-bold mb-2 text-lg">{creator.dept_college}</p>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 text-lg">
                            <a href="#features" className="text-gray-300 text-center hover:text-white transition">Features</a>
                            <a href="#pricing" className="text-gray-300 text-center hover:text-white transition">Pricing</a>
                            <a href="#team" className="text-gray-300 text-center hover:text-white transition">Team</a>
                        </div>
                    </div>
